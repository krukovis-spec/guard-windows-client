...
- Next ordered increment is Stage 6: outbound relay, parent PWA and compact native Android/iPhone biometric-only approval signing. It must preserve the existing exact-request, replay and commit-before-reconcile boundaries; no child Android/iOS agent is part of the first Windows release.
