...
{
    public static class ApplicationRequestPayloadCodec
    {
        ...
        public static byte[] Encode(
            CreateApplicationRequestPayload request)
        {
            if (request == null)
            {
                          ...
                          .MaximumShortReasonUtf8Bytes)))
            {
                throw new ArgumentException(
                    "The encoded application request fields are invalid.",
                    nameof(request));
            }
            ...
            using (var stream = new MemoryStream())
            {
                ...
                if (stream.Length >
                    ApplicationRequestPayloadLimits.MaximumPayloadBytes)
                {
                    throw new ArgumentException(
                        "The application request payload is oversized.",
                        nameof(request));
                }
        ...
        public static CreateApplicationRequestPayload Decode(
            byte[] payload)
        {
            if (payload == null ||
                payload.Length == 0 ||
                    ...
                    ApplicationRequestPayloadLimits.MaximumPayloadBytes)
            {
                throw new InvalidDataException(
                    "The application request payload is empty or oversized.");
            }
            ...
            try
            {
                    ...
                    new MemoryStream(payloadSnapshot, writable: false))
                {
                    ...
                    {
                        throw new InvalidDataException(
                            "The application request payload version is unsupported.");
                    }
                    ...
                    {
                        throw new InvalidDataException(
                            "The application request field lengths are inconsistent.");
                    }
                    ...
                    {
                        throw new InvalidDataException(
                            "Trailing application request bytes are not allowed.");
                    }

                    try
                    {
                        return new CreateApplicationRequestPayload(
                            observationId,
                            shortReason);
                    }
                    ...
                    {
                        throw new InvalidDataException(
                            "The application request fields are invalid.",
                            exception);
                    }
                }
            }
            ...
            {
                throw new InvalidDataException(
                    "The application request payload ended unexpectedly.",
                    exception);
            }
        }
        ...
        private static void RequireMagic(Stream stream)
        {
            ...
            for (var index = 0; index < Magic.Length; index++)
            {
                ...
                {
                    throw new InvalidDataException(
                        "The application request payload magic is invalid.");
                }
            }
        }
