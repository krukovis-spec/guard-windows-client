...
- Граница, требующая согласования: требование «даже полноценному администратору» нельзя гарантировать обычной LocalSystem-службой. Предложено оставить повседневные аккаунты стандартными, администрирование открывать после родительского подтверждения, а отдельный аварийный доступ хранить вне детского ПК. Ответ Ивана ожидается; все аккаунты/последний recovery-admin автоматически не блокировать. Основание: Microsoft Windows security servicing criteria, https://www.microsoft.com/en-us/msrc/windows-security-servicing-criteria (проверено 2026-09-23).
...
## Текущая проверка готовности и русификация
